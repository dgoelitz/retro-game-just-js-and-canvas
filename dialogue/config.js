export const DIALOGUE_CHARACTERS_PER_SECOND = 42;
export const DIALOGUE_BOX_COLOR = "#222034";
export const DIALOGUE_BORDER_COLOR = "#fff1e8";
export const DIALOGUE_TEXT_COLOR = "#fff1e8";
export const DIALOGUE_BOX_MARGIN = 6;
export const DIALOGUE_BOX_PADDING_X = 6;
