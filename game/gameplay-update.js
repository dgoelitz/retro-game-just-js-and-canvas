...
import { GAME_STATE_PLAYING } from "../game-state.js";
import { tickTimer } from "../game-utils.js";
import { getPlayerHitbox, getPlayerPosition, updatePlayer } from "../player/player.js";
import { resolveWeightSwitches } from "../world/room-props.js";
import { handleBlockedDoorAtRoomEdge } from "../world/door-interaction.js";
import { updateRoomCombat } from "./gameplay-combat.js";
import { handleRoomInteraction, updateGameOverStatus } from "./gameplay-interaction.js";
import {
  getActiveRoomState,
  resolvePlayerCollisions,
  tryHandleRoomTransition,
  tryOpenMap
} from "./gameplay-room-state.js";
